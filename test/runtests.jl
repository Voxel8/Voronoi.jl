...
points = Point[]
segments = Segment[Segment(Point(0, 0), Point(0, 640000)),
                   Segment(Point(0, 640000), Point(640000, 640000)),
                   Segment(Point(640000, 640000), Point(640000, 0)),
                   Segment(Point(640000, 0), Point(0, 0))]
